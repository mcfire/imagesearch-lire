 ...
 *
 */
public class SURFImageSearcher extends VisualWordsImageSearcher {

    public SURFImageSearcher(int numMaxHits, Similarity similarity,
			String fieldName) {
    ...
    public ImageSearchHits search(BufferedImage image, ImageInfo imageInfo, IndexReader reader) throws IOException {
    	...
    	Document doc = surfBuilder.createDocument(image, imageInfo);
