 ...
 *
 */
public class MSERImageSearcher extends VisualWordsImageSearcher {

    public MSERImageSearcher(int numMaxHits, Similarity similarity,
			String fieldName) {
    ...
    public ImageSearchHits search(BufferedImage image, ImageInfo imageInfo, IndexReader reader) throws IOException {
    	MSERDocumentBuilder mserBuilder = new MSERDocumentBuilder();
    	Document doc = mserBuilder.createDocument(image, imageInfo);
