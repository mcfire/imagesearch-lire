...
public abstract class AbstractImageSearcher implements ImageSearcher {
    ...
    public ImageSearchHits search(InputStream image, IndexReader reader) throws IOException {
        return search(image, null, reader);
    }
    
    public ImageSearchHits search(InputStream image, ImageInfo imageInfo, IndexReader reader) throws IOException {
        BufferedImage bufferedImage = ImageIO.read(image);
        return search(bufferedImage, imageInfo, reader);
    }
